...
module "data_factories" {
  source         = "git::https://github.com/AeternaModules/azurerm_data_factory.git?ref=v4.81.0"
  data_factories = local.data_factories
}

module "data_factory_credential_service_principals" {
  source                                     = "git::https://github.com/AeternaModules/azurerm_data_factory_credential_service_principal.git?ref=v4.81.0"
...
module "data_factory_credential_user_managed_identities" {
  source                                          = "git::https://github.com/AeternaModules/azurerm_data_factory_credential_user_managed_identity.git?ref=v4.81.0"
...
module "data_factory_custom_datasets" {
  source                       = "git::https://github.com/AeternaModules/azurerm_data_factory_custom_dataset.git?ref=v4.81.0"
  data_factory_custom_datasets = local.data_factory_custom_datasets
  depends_on                   = [module.data_factories]
}

module "data_factory_customer_managed_keys" {
  source                             = "git::https://github.com/AeternaModules/azurerm_data_factory_customer_managed_key.git?ref=v4.81.0"
  data_factory_customer_managed_keys = local.data_factory_customer_managed_keys
  depends_on                         = [module.data_factories]
}

module "data_factory_data_flows" {
  source                  = "git::https://github.com/AeternaModules/azurerm_data_factory_data_flow.git?ref=v4.81.0"
  data_factory_data_flows = local.data_factory_data_flows
  depends_on              = [module.data_factories]
}

module "data_factory_dataset_azure_blobs" {
  source                           = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_azure_blob.git?ref=v4.81.0"
  data_factory_dataset_azure_blobs = local.data_factory_dataset_azure_blobs
  depends_on                       = [module.data_factories]
}

module "data_factory_dataset_azure_sql_tables" {
  source                                = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_azure_sql_table.git?ref=v4.81.0"
  data_factory_dataset_azure_sql_tables = local.data_factory_dataset_azure_sql_tables
  depends_on                            = [module.data_factories]
}

module "data_factory_dataset_binaries" {
  source                        = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_binary.git?ref=v4.81.0"
  data_factory_dataset_binaries = local.data_factory_dataset_binaries
  depends_on                    = [module.data_factories]
}

module "data_factory_dataset_cosmosdb_sqlapis" {
  source                                = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_cosmosdb_sqlapi.git?ref=v4.81.0"
...
module "data_factory_dataset_delimited_texts" {
  source                               = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_delimited_text.git?ref=v4.81.0"
  data_factory_dataset_delimited_texts = local.data_factory_dataset_delimited_texts
  depends_on                           = [module.data_factories]
}

module "data_factory_dataset_https" {
  source                     = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_http.git?ref=v4.81.0"
  data_factory_dataset_https = local.data_factory_dataset_https
  depends_on                 = [module.data_factories]
}

module "data_factory_dataset_jsons" {
  source                     = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_json.git?ref=v4.81.0"
  data_factory_dataset_jsons = local.data_factory_dataset_jsons
  depends_on                 = [module.data_factories]
}

module "data_factory_dataset_mysqls" {
  source                      = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_mysql.git?ref=v4.81.0"
  data_factory_dataset_mysqls = local.data_factory_dataset_mysqls
  depends_on                  = [module.data_factories]
}

module "data_factory_dataset_parquets" {
  source                        = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_parquet.git?ref=v4.81.0"
  data_factory_dataset_parquets = local.data_factory_dataset_parquets
  depends_on                    = [module.data_factories]
}

module "data_factory_dataset_postgresqls" {
  source                           = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_postgresql.git?ref=v4.81.0"
  data_factory_dataset_postgresqls = local.data_factory_dataset_postgresqls
  depends_on                       = [module.data_factories]
}

module "data_factory_dataset_snowflakes" {
  source                          = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_snowflake.git?ref=v4.81.0"
  data_factory_dataset_snowflakes = local.data_factory_dataset_snowflakes
  depends_on                      = [module.data_factories]
}

module "data_factory_dataset_sql_server_tables" {
  source                                 = "git::https://github.com/AeternaModules/azurerm_data_factory_dataset_sql_server_table.git?ref=v4.81.0"
...
module "data_factory_flowlet_data_flows" {
  source                          = "git::https://github.com/AeternaModules/azurerm_data_factory_flowlet_data_flow.git?ref=v4.81.0"
  data_factory_flowlet_data_flows = local.data_factory_flowlet_data_flows
  depends_on                      = [module.data_factories]
}

module "data_factory_integration_runtime_azures" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_data_factory_integration_runtime_azure.git?ref=v4.81.0"
...
module "data_factory_integration_runtime_azure_ssis" {
  source                                      = "git::https://github.com/AeternaModules/azurerm_data_factory_integration_runtime_azure_ssis.git?ref=v4.81.0"
...
module "data_factory_integration_runtime_self_hosteds" {
  source                                        = "git::https://github.com/AeternaModules/azurerm_data_factory_integration_runtime_self_hosted.git?ref=v4.81.0"
...
module "data_factory_linked_custom_services" {
  source                              = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_custom_service.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_blob_storages" {
  source                                          = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_blob_storage.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_databricks" {
  source                                       = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_databricks.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_file_storages" {
  source                                          = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_file_storage.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_functions" {
  source                                      = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_function.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_searches" {
  source                                     = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_search.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_sql_databases" {
  source                                          = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_sql_database.git?ref=v4.81.0"
...
module "data_factory_linked_service_azure_table_storages" {
  source                                           = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_azure_table_storage.git?ref=v4.81.0"
...
module "data_factory_linked_service_cosmosdbs" {
  source                                = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_cosmosdb.git?ref=v4.81.0"
...
module "data_factory_linked_service_cosmosdb_mongoapis" {
  source                                         = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_cosmosdb_mongoapi.git?ref=v4.81.0"
...
module "data_factory_linked_service_data_lake_storage_gen2s" {
  source                                              = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_data_lake_storage_gen2.git?ref=v4.81.0"
...
module "data_factory_linked_service_key_vaults" {
  source                                 = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_key_vault.git?ref=v4.81.0"
...
module "data_factory_linked_service_kustos" {
  source                             = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_kusto.git?ref=v4.81.0"
  data_factory_linked_service_kustos = local.data_factory_linked_service_kustos
  depends_on                         = [module.data_factories]
}

module "data_factory_linked_service_mysqls" {
  source                             = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_mysql.git?ref=v4.81.0"
  data_factory_linked_service_mysqls = local.data_factory_linked_service_mysqls
  depends_on                         = [module.data_factories]
}

module "data_factory_linked_service_odata" {
  source                            = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_odata.git?ref=v4.81.0"
  data_factory_linked_service_odata = local.data_factory_linked_service_odata
  depends_on                        = [module.data_factories]
}

module "data_factory_linked_service_odbcs" {
  source                            = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_odbc.git?ref=v4.81.0"
  data_factory_linked_service_odbcs = local.data_factory_linked_service_odbcs
  depends_on                        = [module.data_factories]
}

module "data_factory_linked_service_postgresqls" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_postgresql.git?ref=v4.81.0"
...
module "data_factory_linked_service_sftps" {
  source                            = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_sftp.git?ref=v4.81.0"
  data_factory_linked_service_sftps = local.data_factory_linked_service_sftps
  depends_on                        = [module.data_factories]
}

module "data_factory_linked_service_snowflakes" {
  source                                 = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_snowflake.git?ref=v4.81.0"
...
module "data_factory_linked_service_sql_managed_instances" {
  source                                            = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_sql_managed_instance.git?ref=v4.81.0"
...
module "data_factory_linked_service_sql_servers" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_sql_server.git?ref=v4.81.0"
...
module "data_factory_linked_service_synapses" {
  source                               = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_synapse.git?ref=v4.81.0"
  data_factory_linked_service_synapses = local.data_factory_linked_service_synapses
  depends_on                           = [module.data_factories]
}

module "data_factory_linked_service_webs" {
  source                           = "git::https://github.com/AeternaModules/azurerm_data_factory_linked_service_web.git?ref=v4.81.0"
  data_factory_linked_service_webs = local.data_factory_linked_service_webs
  depends_on                       = [module.data_factories]
}

module "data_factory_managed_private_endpoints" {
  source                                 = "git::https://github.com/AeternaModules/azurerm_data_factory_managed_private_endpoint.git?ref=v4.81.0"
  data_factory_managed_private_endpoints = local.data_factory_managed_private_endpoints
  depends_on                             = [module.data_factories]
}

module "data_factory_pipelines" {
  source                 = "git::https://github.com/AeternaModules/azurerm_data_factory_pipeline.git?ref=v4.81.0"
  data_factory_pipelines = local.data_factory_pipelines
  depends_on             = [module.data_factories]
}

module "data_factory_trigger_blob_events" {
  source                           = "git::https://github.com/AeternaModules/azurerm_data_factory_trigger_blob_event.git?ref=v4.81.0"
  data_factory_trigger_blob_events = local.data_factory_trigger_blob_events
  depends_on                       = [module.data_factories]
}

module "data_factory_trigger_custom_events" {
  source                             = "git::https://github.com/AeternaModules/azurerm_data_factory_trigger_custom_event.git?ref=v4.81.0"
  data_factory_trigger_custom_events = local.data_factory_trigger_custom_events
  depends_on                         = [module.data_factories]
}

module "data_factory_trigger_schedules" {
  source                         = "git::https://github.com/AeternaModules/azurerm_data_factory_trigger_schedule.git?ref=v4.81.0"
  data_factory_trigger_schedules = local.data_factory_trigger_schedules
  depends_on                     = [module.data_factories]
}

module "data_factory_trigger_tumbling_windows" {
  source                                = "git::https://github.com/AeternaModules/azurerm_data_factory_trigger_tumbling_window.git?ref=v4.81.0"
